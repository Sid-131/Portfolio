...
export default function OpenSource() {
  return (
    <section id="opensource" className="relative z-20 mx-auto max-w-6xl px-6 py-24">
      ...
      <div
        className="glass-card mb-8 flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between"
      >
        <div>
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {openSource.map((repo) => (
          <div key={repo.name} className="glass-card flex flex-col p-6">
